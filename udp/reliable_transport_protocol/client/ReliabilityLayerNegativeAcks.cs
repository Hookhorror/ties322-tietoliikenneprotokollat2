...
namespace client
{
    public class ReliabilityLayerNegativeAcks
    {
        VirtualSocket vs;

        public ReliabilityLayerNegativeAcks()
        {
        ...
        internal void SendMessage(byte[] message, EndPoint ep)
        {
            ...
            {
                System.Console.WriteLine("Odoteltu riittävästi, ei mussutettavaa");
